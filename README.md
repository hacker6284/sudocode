...
| [`backends/lean/`](backends/lean/) | Lean 4 backend (external, protocol 4, `terminates` profile). Not in `ALL_BACKENDS`; see [`backends/lean/STATUS.md`](backends/lean/STATUS.md) |
